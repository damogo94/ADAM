  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="rounded-card-sm border border-white/10 bg-surface-2 p-5">
        ...
        {notice && (
          <div className="mb-3 rounded-lg border border-white/20 bg-white/[0.04] px-3 py-2 font-mono text-[12px] text-ink/85">
            {notice}
          </div>
        )}
      ...
      <p className="mt-4 text-center font-mono text-[12px] text-ink/45 leading-relaxed">
