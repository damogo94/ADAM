...
- Los niveles entrada/stop/target deben ser ejecutables HOY o en próximas sesiones inmediatas — NO patrones genéricos de tu training.
- Si reconoces un patrón histórico famoso (ej. "el doble techo de S&P 2022"), NO lo proyectes: analiza únicamente lo que muestra el OHLCV recibido.
