 ...
 *
 * Caso: tres lecturas alineadas al alza con convicción alta → confluencia alta.
 */
...
export const EXAMPLE: Example = {
  ...
  verdict: {
    ...
    confianza: 'alta',
    porque:
      'Las tres lecturas apuntan arriba con fuerza y se confirman entre sí → confluencia alta al alza.',
    accion:
