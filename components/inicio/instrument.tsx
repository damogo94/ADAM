        ...
        <div className="relative z-10">
          ...
          <div className={cn('border-t px-5 py-5', tone.panelBorder, tone.panelBg)}>
            <div className="flex items-center gap-5">
              <Gauge value={v.actionable_pct} hex={tone.hex} />
            ...
            <div className="mt-5">
              <KappaRule kappa={v.kappa} markerClass={tone.marker} zoneClass={tone.zoneFill} />
            </div>

            {/* micro-readout de la ecuación — el MODELO (honesto), no un fetch */}
            <p className="mt-4 font-mono text-[0.7rem] leading-relaxed text-ink/45">
